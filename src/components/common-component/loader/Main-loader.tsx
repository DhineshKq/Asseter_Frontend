  ...
  return (
    <StyledWrapper>
      <div className="loader JS_on">
        ...
        <span className="binary" />
        <span className="getting-there">Getting Data...</span>
      </div>
    </StyledWrapper>
  );
}
...
position: fixed; // Make sure it sits on top of everything
  top: 0;
  left: 0;
  width: 100vw;
  height: 100vh;
  background-color: rgba(0, 0, 0, 0.6); // Optional: dark transparent background
  display: flex;
