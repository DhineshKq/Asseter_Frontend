...
export default function DocumentModal({ closeDocument, documentFile, showDocumentModal, documentName }: props) {
    ...
    useEffect(() => {
        if (documentFile.file && documentFile.file.name) {
            ...
            const isValidExtension = ['pdf', 'jpg', 'jpeg', 'png', 'bmp'].includes(fileExtension);
    ...
    const downloadfile = async () => {
        ...
        try {
            const response = await axiosPrivate.post(`vcin/get/document`, { fileName: documentFile.file },
                {
